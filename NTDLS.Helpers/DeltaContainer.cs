...
namespace NTDLS.Helpers
{
    ...
    /// </summary>
    public class DeltaContainer<T> where T : INumber<T>
    {
        ...
        /// <summary>
        /// Attempts to calculate the delta between the current value and the previous value for the given key, returns null if no previous value exists.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to calculate the delta/s between the current value and the previous value for the given key, returns null if no previous value exists.
        /// </summary>
